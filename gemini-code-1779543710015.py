...
class VoicetexApp:
    def __init__(self, root):
        ...
        self.status_bar = tk.Label(self.root, text="Modell inicializálása... Kérlek várj...", bg=self.BG_PANEL, fg=self.FG_ACCENT, anchor="w", padding=6, font=("Consolas", 9))
    ...
    def batch_processing_thread(self, wave_path, txt_path):
        try:
            ...
            for i in range(feldolgozando):
                ...
                lora_automatikus_mentes()  # Kötegeltnél is mentünk szakaszosan
    ...
    def run_train_wrapper(self, javitott_szoveg):
        try:
            ...
            # AUTOMATIKUS MENTÉS (ZIP TÖMÖRÍTÉS)

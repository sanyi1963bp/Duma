...
# 📝 LEÍRÁS: Voicetex Gemini Factory Ultra - Dark Mode Edition (Ststabilizált verzió)
...
MODEL_NAME = "openai/whisper-large-v3"  # Ez garantálja az 1280-as dimenzió-egyezést!
